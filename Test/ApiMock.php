...
class ApiMock
{
    ...
    public function __construct()
    {
        ...
        $this->todos[5]     = $this->createTodo(5,  'activity1', 'category1', ['tag1', 'tag2', 'tag3'], 'extra tag',    null,   0,  false);
        ...
        $this->todos[9]     = $this->createTodo(9,  'activity2', 'category1', ['tag2'],                 'other tags',   null,   0,  false);
